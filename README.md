...
## Viewer
Er is een viewer: ://nlcs.ldviewer.com, voor makkelijker sorteren kan men de [Tabellen 5.0](https://github.com/nl-digigo/NLCS/tree/main/tabellen/publicatie) bekijken en downloaden om de inhoud van de database te onderzoeken. 
