...
Ook te kopieren uit [QueryNLCSObjects_original.rq](https://github.com/bimloket/NLCS/blob/main/code/QueryNLCSObjects_original.rq)
...
## Tabel disciplines #219


## Tabellen hoofdgroep #215


## Tabel lijnkleuren #220


## Tabel lijntypes #221


## Tabel lijnweights #222
...
De volgende query vraagt alle lijntypes op.
Ook te kopieren uit [QueryLijntypes.rq](https://github.com/bimloket/NLCS/blob/main/code/QueryLijntypes.rq)
...
De volgende query vraagt alle arceringen op.
Ook te kopieren uit [QueryArceringen.rq](https://github.com/bimloket/NLCS/blob/main/code/QueryArceringen.rq)
...
SELECT DISTINCT ?FASE ?BIB ?ARCERING ?ID ?VRKL_KORT ?VRKL_LANG
WHERE {
...
## Symbolen
De volgende query vraagt alle lagen met symbolen op.
Ook te kopieren uit [QuerySymbolen.rq](https://github.com/bimloket/NLCS/blob/main/code/QuerySymbolen.rq)
