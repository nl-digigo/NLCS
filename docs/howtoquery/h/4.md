...
De queries omvoor een lijst met vervallen concepten, lijst met nieuwe concepten en lijst met concepten die van naam veranderd zijn  staan hier: https://github.com/nl-digigo/NLCS/tree/main/code/5.1/changelog
