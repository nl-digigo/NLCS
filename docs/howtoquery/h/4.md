...
De [query voor arceringen](https://github.com/nl-digigo/NLCS/blob/main/code/actueel/NLCS_Query_Arceringen.rq) resulteert in een tabel zoals deze, gespiegeld voor betere leesbaarheid (de inhoud klopt niet):
...
De [query voor disciplines](https://github.com/nl-digigo/NLCS/blob/main/code/actueel/NLCS_Query_Disciplines.rq) resulteert in een tabel zoals deze:
...
## Wijzigingen tussen versies query-en


De queries omvoor een lijst met vervallen concepten, lijst met nieuwe concepten en lijst met concepten die van naam veranderd zijn staan klaar in het [changelog](https://github.com/nl-digigo/NLCS/tree/main/code/5.1/changelog) (de link verwijst naar versie 5.1)

Daarin staan de volgende query's: 
<figure>
<img src="./h/media/changelog.png" alt="Visuele weergave van de beschikbare query's">
...
<figure>
<img src="./h/media/namedgraphuri.png" alt="Visuele weergave van de plek in Laces Hub waar je de Named Graph URI moet invoeren">
<figcaption>De plek in Laces Hub waar je de Named Graph URI moet invoeren</caption>
</figure>

### Query nieuwe properties
