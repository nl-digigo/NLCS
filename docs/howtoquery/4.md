...
De NLCS changelog executable is [hier](https://github.com/nl-digigo/NLCS/tree/main/beheer/changelog) beschikbaar. De executable opent een console scherm om de voortgang aan te tonen. 
