...
De NLCS-objectentabellen zijn in de vorm van Excel-files geplaatst op https://github.com/nl-digigo/NLCS/tree/main/tabellen/Versie-5.0/NLCS-objecten-5.0. Vanaf NLCS versie 3.0 zijn de tabellen ook beschikbaar gesteld in de vorm van een database. 
