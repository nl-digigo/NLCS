...
<table class="tabel3">
  ...
  <tr>
    <td>0</td>
    <td>URI</td>
    <td>De unieke identifyer van dit object in de linked data publicatie </td>
    <td> voorbeeld: 	example/nlcs/def/c132cd12-d85e-46d8-b862-27c6d713a883 </td>
  </tr>
  <tr>
    <td>A</td>
    <td>Omschrijving
  ...
  <tr>
    <td>B</td>
    <td>STATUS
    <td>per model eenmalig in te voeren
    <td>In de objectentabellen aangeduid met “*”</td>
  </tr>
  <tr>
    <td>C</td>
     <td>Koppelteken
    <td>‘liggend streepje’</td>
    <td>_
  </tr>
  <tr>
    <td>D</td>
  ...
  <tr>
    <td>H - R</td>
    <td>OBJECTENs
    <td>en (waar van toepassing) SUBOBJECTEN, per niveau gescheiden door een underscore: “_”</td>
  </tr>
  <tr>
    <td>S</td>
...
| Attribuut         |
|----------|------|
| FASE     |   bedoelt wordt de status van het object zoals beschreven in de [Eisen aan tekeningen en modellen](https://nl-digigo.github.io/NLCS/requirementscadmodels/#status) | 
| BIB      |  AVH  | 
| opt      | SOD   | 
| ID       | 3962 | 
| VRKL_KORT|     |
