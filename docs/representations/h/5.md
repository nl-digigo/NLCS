...
| Argument                                                             | Toepasbaarheid (2D/3D) | Motivatie                                                                                         |
|----------------------------------------------------------------------|------------------------|---------------------------------------------------------------------------------------------------|
| **Scope (context)**                                                  |                        |                                                                                                   |
| Focus op geometrisch deel van AIM voor beheer van publieke assets     | 3D                     | - Nauwkeurige 3D-modellen zijn cruciaal voor assetmanagement.                                       |
|                                                                        |                        | - Vormt basis voor discipline-specifieke modellen bij vervanging en renovatie.                      |
|                                                                        |                        | - Start met "kern" entiteiten voor structuur, uitbreidbaar bij verdere detaillering.               |
|                                                                        |                        | - Referentie voor ISO19650-processen voor samenwerking met stakeholders.                             |
| **Bedrijfsmodel (conceptueel)**                                       |                        |                                                                                                   |
| Geo-BIM integratie voor publieke assets                               | 3D                     | - Afspraken over referentiesysteem voor positionering.                                              |
|                                                                        | 3D                     | - Borgen van eenduidige geometrische plaatsing van assets.                                          |
|                                                                        | 3D                     | - Handleidingen voor levering van objecten in de omgeving.                                          |
|                                                                        | 3D                     | - Spatial zones afgestemd op behoeften van assetmanagement.                                          |
| **Systeem (logisch)**                                                 |                        |                                                                                                   |
| Relevante IFC-elementen bij Geo-BIM-integratie                        | 3D                     | - IfcAlignment, IfcSpatialZone, IfcLinearElement, IfcGeographicElement.                              |
|                                                                        |                        | - Mogelijkheid voor "USERDEFINED" waardelijsten voor nationale semantiek.                          |
|                                                                        |                        | - Afspraken over toepassing van IFC voor eenduidige integratie met geoBIM en datasets.             |
| **Technologie (fysiek)**                                              |                        |                                                                                                   |
| IFC 4.3.2.0 als ISO-standaard sinds januari 2024                      | 3D                     | - Goedgekeurde standaard essentieel voor succesvolle implementatie en duurzame toegankelijkheid.   |
| Applicaties volgens relevante afsprakenstelsels                       | 3D                     | - Keuze van tools voor IFC-model opbouwen, controleren, beheren en ontsluiten.                      |
|                                                                        |                        | - Uitbreiding van specifieke afspraken volgens geldende normen.                                    |
| **Representatie (out-of-context)**                                    | 3D                     | - Start met laag detailniveau en fysieke ruimten.                                                  |
|                                                                        | 3D                     | - Nauwkeurigheid aangepast aan bedrijfsstandaarden voor assetmanagement.                            |
|                                                                        | 3D                     | - Linking met diverse asset registers mogelijk.                                                    |
|                                                                        | 3D                     | - Modellering volgens domeinstandaarden met LOA, LOI, LOD per IFC-objecttype.                       |
