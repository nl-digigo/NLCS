...
## VH Verhardingen
In verhardingen zijn symbolen opgenomen die voor straatstenen een visualisatie geven; van deze symbolen is ook een "KL" variant opgenomen, KL staat voor ‘Klein’. Deze symbolen worden toegepast wanneer een verharding te smal is om het reguliere symbool in te plaatsen en het rooster niet goed uit de verf komt. 

<figure>
<img src="../../media/vh-symbolen-kl.png" alt="de afbeelding laat zien dat van een symbool met een rooster voor bestrating en variant beschikbaar is, voor als het oppervlak te klein is om het rooster goed te tonen" width=50%>
<figcaption>De gewone en kleine variant van een bestratingssymbool</caption>
</figure>
