...
#### Bugfix
NLCS 5.1 is een grootschalige verbeting van foutjes en ommissies in de documentatie en de publicatie van laagnamen, in kleuren, lijnstijlen, lijnweights en symbolen. Dit leidt tot vermindering van irritaties bij het tekenen volgens de standaard. Het gaat om een groot aantal wijzigingen. Men kan teruglezen welke wijzigingen zijn doorgevoerd door de [issues met milestone 5.1](https://github.com/nl-digigo/NLCS/issues?q=milestone%3A%22Release+5.1+Minor+fixes%E2%80%8B%22+) te selecteren in GitHub. 
...
#### Netbeheer
IN NLCS 5.1 is een toevoeging gedaan met objecten voor de hoofdnetten voor electriciteit. Daartoe is de werking van NLCS uitgebreid met een objecttoestand, in het geval van netten met de toestanden in gebruik (default), in reserve en verlaten. Objecten krijgen voor elke combinatie van objecttoestand en tekenstatus eigen kleuren, lijndiktes en lijnstijlen toegekend. 

Men kan teruglezen welke wijzigingen zijn doorgevoerd door de [issues met milestone 5.4](https://github.com/nl-digigo/NLCS/issues?q=is%3Aissue+milestone%3A%22Release+5.4+Netbeheer%E2%80%8B%22) te selecteren in GitHub. 


#### Verkeersborden
IN NLCS 5.1 is een toevoeging gedaan met verkeersborden. Men kan teruglezen welke wijzigingen zijn doorgevoerd door de [issues met milestone 5.6](https://github.com/nl-digigo/NLCS/issues?q=is%3Aissue+milestone%3A%22Release+5.6+Verkeersborden%22) te selecteren in GitHub. 
