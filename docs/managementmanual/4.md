...
## Inleiding
Dit hoofdstuk beschrijft hoe wijzigingen kunnen worden gemaakt in de beheeromgeving van de linked data publicatie, in de volksmond bekend als de NLCS database.
