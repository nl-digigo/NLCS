...
Het objectgerichte informatiemodel van de NLCS bestaat uit de volgende publicaties:
...
* Onderdeel van de publicatie van de ontologie is de NLCS-NLCS ontology alignment naar de "klassieke" publicatie van de NLCS standaard waarin de laagnamen en visualisatie in CAD worden gedefinieerd. Deze alignment zorgt ervoor dat deze in samenhang gebruikt kunnen worden, waarbij van elke laagnaam en symbool bekend is welk objecttype en met welke attributen en welke waardes erbij hoort.
* Onderdeel van de publicatie van de ontologie zijn de NLCS-IMBOR en NLCS-GWSW alignments. Deze zorgen ervoor dat beheerdata op basis van IMBOR en GWSW kan worden uitgedrukt in de NLCS en vice versa, zodat projecten en beheerder informatie kunnen uitwisselen. 
