...
Zie [GWSW-NLCS](#gwsw-nlcs) voor de eerste uitwerking op het gebied van Rioleringen. Omdat IMBOR 2025 grotendeels gebruik maakt van GWSW voor het onderdeel rioleringen, is één samenhangend alignment gemaakt tussen NLCS, GWSW en IMBOR op het niveau "skos-begrippen" (woordenboek).
