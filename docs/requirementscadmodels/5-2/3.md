...
## Algemeen
*  Tekenobjecten MOETEN 1:1 worden getekend in het model. Op het tekenblad kan het model verschaald worden weergegeven.
...
## Plots
Een plot is een afdruk van een tekeningen of ontwerp op papier of in pdf.

### Plotschalen
*  Omdat objecten 1:1 worden getekend moeten deze meestal op schaal worden geplot. Conform NEN-EN-ISO 5455:1990/C1:1996 MOETEN de volgende aanbevolen plotschalen worden toegepast, of de schalen die ontstaan door vermenigvuldiging van een aanbevolen plotschaal met een gehele macht van 10 (bijvoorbeeld 1:50000 of 1:100000).
...
* Voor zowel de horizontale als de verticale richting MOET dezelfde schaal worden gebruikt. Uitzonderingen kunnen worden gemaakt voor lengteprofielen, waar de schalen in horizontale en verticale richting mogen verschillen. In dat geval moeten de betreffende horizontale en verticale schaalfactoren bij het profiel worden vermeld. 
...
### Algemeen
<ol><li>Objecten worden in NLCS gerepresenteerd door middel van:
<ol><li>Geometrie;
<li>Arceringen;
<li>Symbolen </ol></ol>
