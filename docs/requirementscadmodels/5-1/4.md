...
*  De benaming van maatvoeringstijlen MOETEN als volgt zijn opgebouwd: NLCS-[EENHEID SCHAAL]-TEKSTHOOGTE_[CURSIEF]-MAATVOERINGSYMBOOL[_AANHAALLIJNEN][_BACKGROUNDMASK][_AANTAL DECIMALEN LINEAR][_AANTAL DECIMALEN HOEK] 
...
<table class="tabel3" title="voorbeelden benaming van maatvoeringstijlen">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>NLCS maatvoeringstijl in meters, schaal 1:100, teksthoogte 2.5, pijl als symbool; met backgroundmask</td>
  </tr>
  <tr>
