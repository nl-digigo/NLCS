...
<figure>
<img src="../../media/merktekensrand.png" alt="Voorbeeld merktekens in de rand">
...
<figure>
<img src="../../media/tekenblad.jpg" alt="Voorbeeld Indeling tekenblad">
...
<figure>
<img src="../../media/opmerkingen.png" alt="Positie van het opmerkingenvak">
...
<figure>
<img src="../../media/schaalbalk.png" alt="Grafische weergave van Schaalbalk">
...
<figure>
<img src="../../media/ordeningdetailsprofielen.png" alt="Grafische weergave van Ordening van details en profielen">
...
<figure>
<img src="../../media/opvolgingtekeningen.png" alt="Grafische weergave van opvolging van tekeningen">
...
<figure>
<img src="../../media/voorbeelddoorsnedensymbool.PNG" alt="Grafische weergave van Voorbeeld aanbevolen doorsnedensymbool">
...
<figure>
<img src="../../media/verwijzingaanzicht.PNG" alt="Grafische weergave van Voorbeeld aanbevolen aanzichtsymbool: ">
...
<figure>
<img src="../../media/detail.jpg" alt="Grafische weergave van Verwijzing naar een detail: ">
...
<figure>
<img src="../../media/wijziging.jpg" alt="Grafische weergave van Verwijzing naar een wijziging: ">
...
<li>aanduiding van coördinaten.</ul>
<li>Maatvoeringen MOETEN een verschillende kleur en lijndikte krijgen, afhankelijk van de gebruikte teksthoogte.
</ul>


<figure>
<img src="../../media/maatvoering-voorbeeld.PNG" alt="Grafische weergave van Verwijzing naar een wijziging: ">
<figcaption>
...
<figure>
<img src="../../media/maataanduidingrechtedelen1.jpg" alt="Grafische weergave van De maat aangeven met een maatlijn met haaks daarop twee hulplijnen ">
<figcaption>De maat aangeven met een maatlijn met haaks daarop twee hulplijnen. De maatlijn en de hulplijn doortrekken tot 2 mm voorbij het snijpunt. Op het snijpunt een (open)bolletje (“dot”) van 1 mm  plaatsen. De afstand tussen een hulplijn en het model is vrij te bepalen. Alle lijnen hebben een dikte van 0,18 mm</caption>
  ...
  <figure>
<img src="../../media/maataanduidingrechtedelen2.jpg" alt="Grafische weergave van De maataanduiding aangeven met een maatlijn met haaks daarop twee hulplijnen">
...
<figure>
<img src="../../media/maataanduidingrechtedelen3.png" alt="Grafische weergave van De maat aangeven met een maatlijn met haaks daarop twee hulplijnen ">
...
<figure>
<img src="../../media/circelsbogen1.png" alt="Grafische weergave van voorbeeld Maataanduidingen van cirkels/bogen (lengtemaat)">
...
Een andere mogelijkheid is om de maat van de straal van de betreffende cirkel aan te geven met behulp van een straallijn ([zie hier](#aanduiding-van-cirkels-bogen-diameter-straal)) en bij de maataanduiding van de cirkelboog aan te geven dat deze de boog betreft, waarvoor de straal is aangegeven.
...
<figure>
<img src="../../media/circelsbogen2.jpg" alt="Grafische weergave van voorbeeld Aanduiding van cirkels/bogen (diameter/straal)">
...
<figure>
<img src="../../media/circelsbogen3.jpg" alt="Grafische weergave van voorbeeld Maataanduidingen van hoeken">
<figcaption>Voorbeeld Maataanduidingen van hoeken</caption>
</figure>

<figure>
<img src="../../media/circelsbogen4.jpg" alt="Grafische weergave van voorbeeld Maataanduidingen van hoeken">
<figcaption>Voorbeeld Maataanduidingen van hoeken</caption>
</figure>
...
<figure>
<img src="../../media/hoogtematen1.jpg" alt="Grafische weergave van voorbeeld hoogtematen">
<figcaption>Voorbeeld hoogtematen</caption>
</figure>


<figure>
<img src="../../media/hoogtematen2.jpg" alt="Grafische weergave van voorbeeld hoogtematen">
<figcaption>Voorbeeld hoogtematen</caption>
</figure>
...
<figure>
<img src="../../media/metrering.jpg" alt="Grafische weergave van voorbeeld Metrering">
...
<figure>
<img src="../../media/alignementen.png" alt="Grafische weergave van voorbeeld alignementen">
...
<figure>
<img src="../../media/alignementen2.png" alt="Grafische weergave van voorbeeld alignementen">
<figcaption>Voorbeeld alignementen</caption>
</figure>


### Benaming van maatvoeringstijlen 
*  De benaming van maatvoeringstijlen MOETEN als volgt zijn opgebouwd: NLCS-*[EENHEID SCHAAL]*-[TEKSTHOOGTE] _ *[CURSIEF]* - [MAATVOERINGSYMBOOL] _ *[AANHAALLIJNEN]* _ *[BACKGROUNDMASK]* _ *[AANTAL DECIMALEN LINEAR]* _ *[AANTAL DECIMALEN HOEK]*

| Onderdeel naam                  | Toelichting                                                                                                           |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------|
| NLCS-                      | Veld MOET voorkomen. Waarde altijd NLCS-                                                                                                               |
| [EENHEID SCHAAL]-         | VIndien van toepassing MOET de eenheid en schaal worden toegevoegd.       |
| TEKSTHOOGTE                | Veld MOET voorkomen. Waarde altijd Txx, waarbij xx de teksthoogte in mm/10 is                                                                                |
...
<table class="tabel3" title="voorbeelden benaming van maatvoeringstijlen">
  <tr>
    <th>Stijl</th>
    <th>Beschrijving</th>
  </tr>
  <tr>
    ...
    <td>NLCS maatvoeringstijl in meters, schaal 1:100, teksthoogte 2.5 mm, pijl als symbool;</td>
  </tr>
   <tr>
    <td>NLCS-M100-T25-PIJL_BG</td>
    <td>NLCS maatvoeringstijl in meters, schaal 1:100, teksthoogte 2.5 mm, pijl als symbool; met backgroundmask</td>
  </tr>
  <tr>
    <td>NLCS-MM20-T25_CURSIEF_BOL</td>
    <td>NLCS maatvoeringstijl in millimeters, schaal 1:20, teksthoogte 2.5 mm, tekst cursief, bol als symbool;</td>
  </tr>
  <tr>
    <td>NLCS-M500-T25-OPENBOL</td>
    <td>NLCS maatvoeringstijl: in meters, schaal 1:500, teksthoogte 2.5 mm, open bol als symbool;</td>
  </tr>
  <tr>
    <td>NLCS-M500-T18-SCHRAP</td>
    <td>NLCS maatvoeringstijl in meters, schaal 1:500, teksthoogte 1.8 mm, schrap als symbool;</td>
  </tr>
  <tr>
    <td>NLCS-ANNOTATIEF-T25-PIJL</td>
    <td>NLCS maatvoeringstijl met teksthoogte 2.5 mm, pijl als symbool, annotatief; in dit geval is de eenheid in de naam niet van belang vanwege de annotatieve schaal;</td>
  </tr>
  <tr>
    <td>NLCS-M100-T25-PIJL-L2_H1</td>
    <td>NLCS maatvoeringstijl in meters, schaal 1:100, teksthoogte 2.5 mm, pijl als symbool, zonder aanhaallijnen, 2 decimalen voor lineaire maten, 1 decimaal voor hoeken;</td>
  </tr>
  <tr>
    <td>NLCS-M500_T25-OPENBOL_L2_H1</td>
    <td>NLCS maatvoeringstijl: in meters, schaal 1:500, teksthoogte 2.5 mm, open bol als symbool, zonder aanhaallijnen, 2 decimalen voor lineaire maten, 1 decimaal voor hoeken;</td>
  </tr>
  <tr>
    <td>NLCS-MM20-T25_CURSIEF-BOL_A_L2_H2</td>
    <td>NLCS maatvoeringstijl in millimeters, schaal 1:20, teksthoogte 2.5 mm, tekst cursief, bol als symbool, met aanhaallijnen, 2 decimalen voor lineaire maten, 2 decimalen voor hoeken.</td>
  </tr>
</table>

## Teksten op tekeningen
...
<figure>
<img src="../../media/font.PNG" alt="Grafische weergave van voorbeeld Font">
...
<body>
  ...
  <tr>
    ...
    <td>Vrij te bepalen op basis van leesbaarheid tekening</td>
...
<body>
    <!-- HTML-element met de class "onderstreept-tekst" -->
    <p class="schaalaanduiding">N.A.P.</p>
</body></td>
  </tr>
  <tr>
...
<figure>
<img src="../../media/positionerenvantekst.png" alt="Grafische weergave van positionering van tekst in verschillende richtingen op de tekening">
<figcaption>Positionering van tekst in verschillende richtingen op de tekening</caption>
</figure>

* In geval van aanduidingen van profielen in een tracé of alignement is het logisch om de tekst haaks op de richting van het alignement te plaatsen, zie ook de figuur in [deze paragraaf](#verwijzing-naar-een-doorsnede)
...
<figure>
<img src="../../media/onderschriften.png" alt="Grafische weergave van Onderschriften en schaalaanduidingen op de tekening">
...
<figure>
<img src="../../media/doorsnede.png" alt="Grafische weergave van Doorsnedeverwijzing op de tekening" width = 50%>
...
<figure>
<img src="../../media/aanhaallijnen.jpg" alt="Grafische weergave van Aanhaallijnen op de tekening">
...
<figure>
<img src="../../media/aanpijling.png" alt="Grafische weergave van aanhaallijn met aanduiding van vlak op de tekening">
<figcaption>Aanhaallijn met aanduiding van vlak op de tekening</caption>
</figure>

### Benaming tekststijlen 
* De benaming van maatvoeringstijlen MOETEN als volgt zijn opgebouwd: [LETTERTYPE]-[EENHEID SCHAAL]-[TEKSTHOOGTE] _ [CURSIEF] _ [BACKGROUNDMASK]
...
|  [EENHEID SCHAAL]  |  Indien van toepassing MOET de eenheid en schaal worden toegevoegd.  |
| [TEKSTHOOGTE]                | Veld MOET voorkomen. Waarde altijd Txx, waarbij xx de teksthoogte in mm/10 is                                                                                |
| [CURSIEF]                | Indien van toepassing MOET de waarde _CURSIEF zijn ingevoegd                                                                                |
| [BACKGROUNDMASK]         | Indien van toepassing MOET de waarde _BG zijn ingevoegd                                                                                           |


Voorbeelden:
| Stijl                | Beschrijving                                            |
|----------------------|--------------------------------------------------------|
| NLCS-ISO-T18           | NLCS tekststijl, teksthoogte 1.8mm             |
| NLCS-ISO-M100_T35    | NLCS tekststijl in meters, schaal 1:100, teksthoogte 3.5 mm.         |
| NLCS-ISO-MM20-T18_CURSIEF | NLCS tekststijl in millimeters, schaal 1:20, teksthoogte 1.8 mm., tekst cursief |
| NLCS-ISO-MM20-T18_CURSIEF_BG | NLCS tekststijl in millimeters, schaal 1:20, teksthoogte 1.8 mm., tekst cursief met backgroundmask |
| NLCS-ISO-ANNOTATIEF-T25   | NLCS tekststijl met annotatieve schaal, teksthoogte 2.5 mm.        |
|  NLCS-RVV-M1-T3000   |   NLCS tekststijl RVV in meters, schaal 1:1, teksthoogte 300mm (standaard RVV-bord bibeko)  |

Zie [hier](#benaming-van-maatvoeringstijlen) Voor de benaming van multileaderstijlen.
...
<figure>
<img src="../../media/ruitkruisjecompas.png" alt="Grafische weergave van ruitkruisje">
<figcaption>Ruitkruisje</caption>
</figure>


<figure>
<img src="../../media/voorbeeldtekeniggruitkruisje.png" alt="Grafische weergave van tekening met Noordpijl en ruitkruisjes">
