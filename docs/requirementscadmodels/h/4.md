...
*  Het lettertype voor bemating heeft een (geplotte) teksthoogte van 1,8 mm. 
...
*  Peilmaten als tekst komen op een laag met element T, als het 'block' wordt toegepast op een laag met element S.
