...
*  In NLCS wordt bij elke laag en per status een van de standaard lijndiktes voorgeschreven. 
* Voor de status N gerbuikt de standaard een van de volgende lijndiktes: 0.25, 0.35 en 0.50.
