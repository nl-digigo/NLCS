...
<li>De gebruikte eenheid voor maataanduidingen MOETEN als in het voorbeeld in het opmerkinggedeelte van de strook voor de verklaring boven of links naast het stempel worden weergegeven: 
<ul>
<li>Materiaalmaten in mm, tenzij anders vermeld
<li>Peilmaten in meters t.o.v. N.A.P., tenzij anders vermeld </ul>
...
*  De verschillende wijzen waarop objecten in NLCS kunnen worden gerepresenteerd, worden in de systematiek ELEMENTEN genoemd. Voor het overzicht van de ELEMENTEN [zie hier](#element).
...
*  Lijndikte en lijntype van een object in aanzicht wijken af van lijndikte en lijntype van hetzelfde object in doorsnede of als ‘niet zichtbaar’. De lijndikten, de –kleuren en –typen van een object in doorsnede en ‘niet zichtbaar’ worden afgeleid van de lijndikte, de lijnkleur en het lijntype van het object in aanzicht volgens een vaste set van afspraken. Deze afspraken zijn [hier](#samenvatting-representatie-van-objecten-in-nlcs) samengevat.
*  Zie deze paragrafen over [tekst](https://nl-digigo.github.io/NLCS/requirementscadmodels/#tekst) en [maatvoering](https://nl-digigo.github.io/NLCS/requirementscadmodels/#maatvoering)
...
* Als in GD het lijntype continous niet logisch is, omdat het geen fysiek object betreft maar bijvoorbeeld een afbreeklijn, NAP lijn of 'bestaand' maaiveld, mag een ander lijntype worden toegepast.
...
<li>Gebruikers en/of CAD-leveranciers kunnen desgewenst eigen arceringenbibliotheken of bibliotheken van derden toevoegen aan de basisset, mits die bibliotheken zijn opgebouwd volgens de [coderingssystematieksystematiek](https://nl-digigo.github.io/NLCS/requirementscadmodels/#coderingssystematiek-lagenstructuur).
...
<li>Gebruikers en/of CAD-leveranciers kunnen voor objecten waarvoor in NLCS geen gewenste symbolen zijn opgenomen, eigen symbolenbibliotheken of bibliotheken van derden toevoegen, mits die bibliotheken zijn opgebouwd volgens de [coderingssystematieksystematiek](https://nl-digigo.github.io/NLCS/requirementscadmodels/#coderingssystematiek-lagenstructuur).
...
<ul><li>lijndikte voor symbolen: Status Bestaand 0.18, overige statussen 0.25;
...
<p id="footnote-3">[3] Uitzondering op de lijndikte van GD is dat daar waar lijnen dichtvloeien bij het afdrukken (bijvoorbeeld bij doorsneden van damwanden en staalprofielen) juist een pendikte dunner mag worden gebruikt. Ook voor wapeningstaven geldt een uitzondering: deze kunnen worden getekend met zowel pendikte 0.5 als pendikte 0.7, ongeacht of het een staaf in aanzicht of in doorsnede betreft.</p>
<p id="footnote-4">[4] Als in GD het lijntype continous niet logisch is, omdat het geen fysiek object betreft maar bijvoorbeeld een afbreeklijn, NAP lijn of 'bestaand' maaiveld, mag een ander lijntype worden toegepast.</p>
