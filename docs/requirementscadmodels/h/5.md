...
<ol><li>Aan ieder OBJECT of SUBOBJECT wordt een ELEMENT toegevoegd.
...
<li>Een ELEMENT geeft weer wat er in de laag is getekend: een of meer [grafische representaties](#representatie-van-objecten) van een (SUB)OBJECT, zoals geometrie, arcering of symbool; of een hulpelement voor duiding van de tekening zoals een tekst of maatvoering.
<li> In de NLCS worden de volgende elementen onderscheiden:
</ol>
